         ...
         <form method="POST" action="">
            <table>
              <tr>
                ...
                <td>
                  <input type="text" placeholder="titre" id="titre" name="titre" value="<?php if(isset($titre)) { echo $titre; } ?>" />
                </td>
              </tr>
              <tr>
                <td align="right">
              ...
              <tr>
                ...
                <td>
                  <input type="text" placeholder="date" id="date" name="date" value="<?php if(isset($date)) { echo $date; } ?>" />
                </td>
              </tr>
               <tr>
                  <td align="right">
