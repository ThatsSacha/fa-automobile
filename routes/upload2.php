...
<head>
    ...
    <title>Formulaire d'upload de fichiers pour votre nouvelle activité</title>
</head>
<body>
  <header class="Banner">
      ...
      <div id="wrapper" class="active">
          <div id="sidebar-wrapper">
            ...
            <form action="controler.php" method="post" enctype="multipart/form-data" >
              <input type="text" class="form-control col-lg-4" name="event_name" placeholder="Nom de l'évènement" autofocus required>
              <textarea cols="30" rows="10" class="form-control col-lg-4" name="event_text" placeholder="Texte de l'évènement" required></textarea>
              <input type="file" class="form-control col-lg-4" name="event_picture" required>
              <input type="submit" class="btn btn-success col-lg-4" name="submit_event" value="Ajouter">
            </form>
          ...
          if(isset($_FILES["photo"]) && $_FILES["photo"]["error"] == 0){
              ...
              if(in_array($filetype, $allowed)){
                  ...
                  if(file_exists("upload/" . $_FILES["photo"]["name"])){
                      ...
                      echo "Votre fichier a été téléchargé avec succès.<a href=\"newmanif.php\">Continuer la création</a>";
                      session_start();
