...
<body>
  <header>
    ...
    <title>CGU</title><style type="text/css">
    <!--
    .Style1 {color: red}
    -->
    </style>
    ...
    <p>L'accés et l'utilisation du site sont soumis à l'acceptation et au respect des présentes Conditions Générales d'Utilisation (CGU).</p>
    ...
    <h2>2.	Gestion du site, accés et navigation</h2>
    <p>L'éditeur met en oeuvre les solutions techniques à sa disposition pour permettre l'accés au site 24 heures sur 24, 7 jours sur 7. Il pourra néanmoins à tout moment suspendre, limiter une catégorie déterminée d'internaute ou interrompre l'accés au site ou à certaines pages de celui-ci afin de procéder à des mises à jour, des modifications de son contenu ou toute autre action jugée nécessaire au bon fonctionnement du site.</p>
    <p>Il pourra également supprimer toute information pouvant en perturber le fonctionnement ou entrant en contravention avec les lois nationales ou internationales, ou avec les régles de la Nétiquette</a>.</p>
    <p>La connexion et la navigation sur ce site valent acceptation sans réserve des présentes Conditions Générales d'Utilisation, quelques soient les moyens techniques d'accés et les terminaux utilisés.</p>
    ...
    <ul>
    	<li>en cas de problémes ou défaillances techniques, informatiques ou de compatibilité du site avec un matériel ou logiciel quel qu'il soit ;</li>
    	...
    	<li>des contenus ou activités illicites utilisant son site et ce, sans qu'il en ait pris dément connaissance au sens de la Loi n 2004-575 du 21 juin 2004 pour la confiance dans l'économie numérique et du Réglement Général européen sur la Protection des Données (RGPD) relative à la protection des personnes physiques à l'égard de traitement de données à caractère personnel.</li>
    </ul>
    ...
    <p>Le site peut contenir des liens hypertextes pointant vers d'autres sites internet sur lesquels ce site n'exerce pas de contrôle. Malgrés les vérifications préalables et régulières réalisées par l'éditeur, celui-ci décline tout responsabilité quant aux contenus qu'il est possible de trouver sur ces sites.</p>
    ...
    <p>Les présentes Conditions Générales d'Utilisation sont régies par la loi française. En cas de différend et à défaut d'accord amiable, le litige sera porté devant les tribunaux français conformèment aux régles de compétence en vigueur.</p>

<footer class="py-5 bg-dark" >
  <div class="foot" align="center">
    <a class="" href="legal.html">Mentions Légales</a>
    <!-- Add icon library -->
